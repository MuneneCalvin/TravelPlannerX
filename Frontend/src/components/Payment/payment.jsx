...
function payment() {
  ...
  <div className="credit-card-info--htmlForm">
      <div className="input_container">
        <label htmlFor="password_field" className="input_label">Card holder full name</label>
        <input id="password_field" className="input_field" type="text" name="input-name" title="Inpit title" placeholder="Enter your full name" required />
      </div>
      <div className="input_container">
      ...
      <div className="input_container">
        ...
        <div className="split">
        <input id="password_field" className="input_field" type="text" name="input-name" title="Expiry Date" placeholder="01/23" required />
        <input id="password_field" className="input_field" type="number" name="cvv" title="CVV" placeholder="CVV" required />
      </div>
      </div>
  </div>
    <button className="purchase--btn" onClick={sendConfirmationEmail}>Checkout</button>
</form>
</div>
</div>
  )
